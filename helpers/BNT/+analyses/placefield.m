...
% by applying a global threshold. During the second step connected regions are labelled
...
%                   are integer values greater or equal to 0. The elements labelled 0
%                   are the background (not a place field). The pixels labelled 1 make up
%                   first field; the pixels labelled 2 make up a second object; and so on.
%
